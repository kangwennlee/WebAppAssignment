...
<table>
                    <asp:DataList ID="DataList1" runat="server">
                        ...
                        <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="width:200px;"><span class="image fit"><asp:Image ID="Image1" runat="server"
                    ...
                    <tr><td><asp:Label ID="cartrowCountLabel" runat="server" Text=""></asp:Label></td></tr>
                    <tr><td><asp:Button ID="checkoutBtn1" runat="server" Text="Checkout" class="button special" onClick="CheckoutBtn_Command"/></td></tr>
                    </table>